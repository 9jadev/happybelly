...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    ...
    _countryDialCode = "NG";
    // _countryDialCode = CountryCode.fromCountryCode(Get.find<SplashController>().configModel.country!).code!;
  }
                      ...
                      child: Container(
                        ...
                        decoration: const BoxDecoration(
                          image: DecorationImage(
                            image: NetworkImage(
                                "https://res.cloudinary.com/examqueat/image/upload/v1703259298/wkdd895y5agnepx0eefy.png"),
                            fit: BoxFit.cover,
                          ),
                        ),
                        child: Image.network(
                            "https://res.cloudinary.com/examqueat/image/upload/v1703259868/toubdol3pvtahqvpzqnt.png"),
                      ),
                    ),
                    Expanded(
                      child: SizedBox(
